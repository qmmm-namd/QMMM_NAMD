...
from interface_chemshell_qm.chemshell import *
from interface_chemshell_2_qm.chemshell_2 import *
...
#               shutil.copy2(file_path, SUB_DIR)
    ...
    def run(self):
        ...
        if qm_package == 101:
            ...
            # call chemshell
            print("chemshell interfaced with qchem is running\n")
            Chemshell()
        elif qm_package == 208:
            # call chemshell
            print("chemshell interfaced with orca is running\n")
            Chemshell()
        elif qm_package == 304:
            # call chemshell
            print("chemshell interfaced with MNDO99 is running while mm part is not frozen\n")
            Chemshell_2()
        elif qm_package == 307:
            # call chemshell
            print("chemshell interfaced with qchem is running while mm part is not frozen\n")
            Chemshell_2()
        else:
            # not done.
            # exit.
