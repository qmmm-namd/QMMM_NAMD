...
class molpro_run:
    ...
    def run(self):
        ...
        molpro_tmp_dir = os.getcwd() 
        molpro_tmp_dir = molpro_tmp_dir.split('/')
        s2 = molpro_tmp_dir.index('QC_TMP')
        #        exec_name1 = exec_name + " < " + jobin + " > " + jobout
        exec_name = exec_name + " -d /dev/shm/" + molpro_tmp_dir[s2 - 1] + " -W ./wfu " + jobin + ' -o ' + jobout
#        exec_name = exec_name + " -W ./wfu " + jobin + ' -o ' + jobout
