...
from .chemshell_create import *
from .chemshell_parser import *
from io import open


class chemshell_run(object):
    ...
    def prepare(self):
        ...
        chemshell = chemshell_create(self.config)
    ...
    def analyze(self):
        ...
        chemshell = chemshell_parser(self.config)
