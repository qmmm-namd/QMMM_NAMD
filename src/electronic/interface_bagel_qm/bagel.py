# python
from bagel_run import *
from bagel_template import *
...
class Bagel():
    def __init__(self):
        ...
        self.files = {"interface": "interface.json", "dyn": "inp.json", \
                      "bagel_template": "./BAGEL_EXAM/bagel_template.json"}
        ...
        dyn_file_all = ['qm_other.dat','current_state.out', 'dynamics.out', 'ele_time.out', 'energy_time.out', 'grad_time.out', 'hop_all_time.out', 'pe_time.out', 'restart_all', 'traj_time.out', 'vel_time.out', 'di_time.out',]
...
#
    ...
    def prepare(self):
        ...
        # bagel directory structure info.
