subroutine sub_elec_motion_2_no_aver_PES_1step_dx_div_dt_adia(dssign, &
                           p_nuc_div_mass, &
                           x_elec, &
                           p_elec, &
                           ene, &
...
if(label_debug >= 2) then
  write(*,*) 'sub_elec_motion_2_no_aver_PES_1step_dx_div_dt_adia'
  write(*,*) 'begining'
...
! diagonal term
do i_state = 1, n_state
  dx_elec_div_dt(i_state) = dssign * p_elec(i_state) * ene(i_state)
enddo
if(label_debug >= 2) then
  write(*,*) 'sub_elec_motion_2_no_aver_PES_1step_dx_div_dt_adia'
  write(*,*) '1'
