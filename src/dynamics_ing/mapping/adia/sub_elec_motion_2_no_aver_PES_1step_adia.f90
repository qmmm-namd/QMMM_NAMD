subroutine sub_elec_motion_2_no_aver_PES_1step_adia(p_nuc_div_mass, &
                           x_elec, &
                           p_elec, &
                           ene, &
                           dij, &
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
dssign = -1.d0
call sub_elec_motion_2_no_aver_PES_1step_dx_div_dt_adia(dssign, &
                           p_nuc_div_mass, &
                           p_elec, &
                           x_elec, &
                           ene, &
...
if(label_debug >= 2) then
  ...
  write(*,*) 'call sub_elec_motion_2_no_aver_PES_1step_dx_div_dt_adia done'
